    ...
    <div className='w-full px-[12%] py-20 flex flex-col md:flex-row items-center justify-between gap-10'>
      <div className='flex-1'>
        <h1 className='text-5xl md:text-6xl font-bold mb-6 font-ovo'>
          Hi, je suis <span className='text-blue-600 dark:text-blue-500'>Josias Boco</span>
        </h1>
        ...
        <p className='text-gray-200 mb-8 max-w-lg font-ovo'>
          Je conçois et développe des applications web réactives et intuitives, pensées pour stimuler la croissance des entreprises et offrir des expériences utilisateurs mémorables.
        </p>
      ...
      <div className='flex-1 flex justify-center'>
        <div className='relative w-80 h-80 rounded-full bg-gray-800 overflow-hidden border-4 border-gray-700 shadow-lg'>
          <Image src='/josias.png' alt='Josias Boco' layout='fill' objectFit='cover' />
        </div>
      </div>
    </div>
  );
